...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 실제 Claude 앱처럼 필요한 링크만 간결하게 인용하도록 안내를 덧붙인다.
    // (검색 횟수를 줄이고, 출처를 나열하지 말고 자연스럽게 1~2개만 언급하도록 지시)
    system += "\n\n웹 검색 결과를 인용할 때는 모든 출처를 나열하지 말고, " +
      "가장 신뢰할 수 있는 링크 1~2개만 문장 속에 자연스럽게 포함해줘. " +
      "출처 목록을 따로 만들지 마.";
